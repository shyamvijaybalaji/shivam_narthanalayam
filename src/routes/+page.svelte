  ...
  <div class="container-custom py-8">
    <div class="grid lg:grid-cols-12 gap-6 items-center">
      ...
      <div class="lg:col-span-6 flex items-center justify-center relative">
        ...
        <div class="absolute top-[45%] left-[15%] lg:top-[48%] lg:left-[20%] -translate-y-1/2 w-[25%] h-[18%] lg:w-[22%] lg:h-[16%] backdrop-blur-md" style="mask-image: radial-gradient(ellipse, black 20%, rgba(0,0,0,0.5) 50%, transparent 100%);"></div>
      </div>
