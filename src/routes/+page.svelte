  ...
  <div class="container-custom py-8">
    <div class="grid lg:grid-cols-12 gap-6 items-center">
      ...
      <div class="lg:col-span-6 flex items-center justify-center relative">
        ...
        <div class="lg:hidden absolute top-[50%] left-[1%] -translate-y-1/2 w-[36%] h-[18%] backdrop-blur-md" style="mask-image: radial-gradient(ellipse at 45% 50%, black 20%, rgba(0,0,0,0.5) 50%, transparent 100%);"></div>
